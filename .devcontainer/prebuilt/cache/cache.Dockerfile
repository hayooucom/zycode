...
# Other image contents: https://github.com/microsoft/zycode-dev-containers/blob/master/repository-containers/images/github.com/microsoft/zycode/.devcontainer/base.Dockerfile

# This first stage generates cache.tar
FROM mcr.microsoft.com/zycode/devcontainers/repos/microsoft/zycode:dev as cache
ARG USERNAME=node
...
FROM mcr.microsoft.com/zycode/devcontainers/repos/microsoft/zycode:dev as dev-container
ARG USERNAME=node
ARG CACHE_FOLDER="/home/${USERNAME}/.devcontainer-cache"
