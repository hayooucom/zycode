...
call "%INTEGRATION_TEST_ELECTRON_PATH%" %~dp0\..\extensions\zycode-api-tests\testWorkspace --enable-proposed-api=zycode.zycode-api-tests --extensionDevelopmentPath=%~dp0\..\extensions\zycode-api-tests --extensionTestsPath=%~dp0\..\extensions\zycode-api-tests\out\singlefolder-tests %API_TESTS_EXTRA_ARGS%
if %errorlevel% neq 0 exit /b %errorlevel%

echo.
echo ### API tests (workspace)
call "%INTEGRATION_TEST_ELECTRON_PATH%" %~dp0\..\extensions\zycode-api-tests\testworkspace.code-workspace --enable-proposed-api=zycode.zycode-api-tests --extensionDevelopmentPath=%~dp0\..\extensions\zycode-api-tests --extensionTestsPath=%~dp0\..\extensions\zycode-api-tests\out\workspace-tests %API_TESTS_EXTRA_ARGS%
if %errorlevel% neq 0 exit /b %errorlevel%

echo.
echo ### Colorize tests
call "%INTEGRATION_TEST_ELECTRON_PATH%" %~dp0\..\extensions\zycode-colorize-tests\test --extensionDevelopmentPath=%~dp0\..\extensions\zycode-colorize-tests --extensionTestsPath=%~dp0\..\extensions\zycode-colorize-tests\out %API_TESTS_EXTRA_ARGS%
if %errorlevel% neq 0 exit /b %errorlevel%
