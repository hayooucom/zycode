			...
			<head>
				...
				<style nonce="${nonce}">
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--zycode-button-secondaryBackground);
						border-color: var(--zycode-button-border);
						border-radius: 50%;
						cursor: pointer;
					...
					#scroll-to-top:hover {
						background-color: var(--zycode-button-secondaryHoverBackground);
						box-shadow: 2px 2px 2px rgba(0,0,0,.25);
					}

					body.zycode-high-contrast #scroll-to-top {
						border-width: 2px;
						border-style: solid;
						box-shadow: none;
					}
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--zycode-button-secondaryForeground);
						/* Chevron up icon */
