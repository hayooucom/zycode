 ...
 */
export const webviewResourceBaseHost = 'zycode-cdn.net';

export const webviewRootResourceAuthority = `zycode-resource.${webviewResourceBaseHost}`;
 ...
 *
 * ```txt
 * ${scheme}+${resource-authority}.zycode-resource.zycode-cdn.net/${path}
 * ```
 *
