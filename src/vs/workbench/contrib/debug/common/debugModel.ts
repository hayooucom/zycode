...
export class Variable extends ExpressionContainer implements IExpression {
	...
	async setVariable(value: string, stackFrame: IStackFrame): Promise<any> {
		...
		try {
			// Send out a setExpression for debug extensions that do not support set variables https://github.com/microsoft/zycode/issues/124679#issuecomment-869844437
