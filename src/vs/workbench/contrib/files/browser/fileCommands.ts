...
async function saveSelectedEditors(accessor: ServicesAccessor, options?: ISaveEditorsOptions): Promise<void> {
	...
	if (!editors) {
		...
		if (activeGroup.activeEditor) {
			...
			//
			// See also https://github.com/microsoft/zycode/issues/4180
			// See also https://github.com/microsoft/zycode/issues/106330
			// See also https://github.com/microsoft/zycode/issues/190210
			if (
