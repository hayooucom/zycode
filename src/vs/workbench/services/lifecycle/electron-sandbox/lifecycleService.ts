...
export class NativeLifecycleService extends AbstractLifecycleService {
	...
	private registerListeners(): void {
		...
		ipcRenderer.on('zycode:onBeforeUnload', async (event: unknown, reply: { okChannel: string; cancelChannel: string; reason: ShutdownReason }) => {
		...
		ipcRenderer.on('zycode:onWillUnload', async (event: unknown, reply: { replyChannel: string; reason: ShutdownReason }) => {
