...
const enum ShutdownConstants {
	 ...
	 * [2]: https://github.com/microsoft/zycode/issues/71966
...
const enum Constants {
	 ...
	 * hang issue. See:
	 * - https://github.com/microsoft/zycode/issues/71966
	 * - https://github.com/microsoft/zycode/issues/117956
	 * - https://github.com/microsoft/zycode/issues/121336
	 */
	 ...
	 * written to the terminal. See https://github.com/microsoft/zycode/issues/38137
	 */
...
export class TerminalProcess extends Disposable implements ITerminalChildProcess {
	...
	shutdown(immediate: boolean): void {
		...
		// mitigation for https://github.com/microsoft/zycode/issues/71966 which causes the pty host
	...
	async getCwd(): Promise<string> {
		if (isMacintosh) {
			...
			// https://github.com/Microsoft/zycode/issues/105446
