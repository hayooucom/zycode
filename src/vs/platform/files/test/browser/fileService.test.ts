...
suite('File Service', () => {
	...
	test('error from readFile bubbles through (https://github.com/microsoft/zycode/issues/118060) - async', async () => {
		testReadErrorBubbles(true);
	});

	test('error from readFile bubbles through (https://github.com/microsoft/zycode/issues/118060)', async () => {
	...
	test('readFile/readFileStream supports cancellation (https://github.com/microsoft/zycode/issues/138805)', async () => {
		const service = new FileService(new NullLogService());
