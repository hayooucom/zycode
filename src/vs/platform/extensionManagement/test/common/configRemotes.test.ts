...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('https://github.com/microsoft/zycode.git'), allowedDomains), ['github.com']);
	...
	test('SCP-like remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('git@github.com:microsoft/zycode.git'), allowedDomains), ['github.com']);
	...
	test('Multiple remotes', function () {
		const config = ['https://github.com/microsoft/zycode.git', 'https://git.example.com/gitproject.git'].map(remote).join('');
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['https://github.com/microsoft/zycode.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('https://github.com/microsoft/zycode.git')), ['github.com/microsoft/zycode.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('https://github.com/microsoft/zycode.git'), true), ['github.com/microsoft/zycode']);
		...
		assert.deepStrictEqual(getRemotes(remote('https://github.com/microsoft/zycode.git'), true), getRemotes(remote('https://github.com/microsoft/zycode')));
	...
	test('SCP-like remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('git@github.com:microsoft/zycode.git')), ['github.com/microsoft/zycode.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:microsoft/zycode.git'), true), ['github.com/microsoft/zycode']);
		...
		// Compare Striped .git with no .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:microsoft/zycode.git'), true), getRemotes(remote('git@github.com:microsoft/zycode')));
	...
	test('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/microsoft/zycode.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
		assert.deepStrictEqual(getRemotes(config), ['github.com/microsoft/zycode.git', 'git.example.com/gitproject.git']);

		// Strip .git
		assert.deepStrictEqual(getRemotes(config, true), ['github.com/microsoft/zycode', 'git.example.com/gitproject']);

		// Compare Striped .git with no .git
		const noDotGitConfig = ['https://github.com/microsoft/zycode', 'https://git.example.com/gitproject'].map(remote).join(' ');
