...
/**
 * Copied from: https://github.com/microsoft/zycode-node-debug/blob/master/src/node/pathUtilities.ts#L83
 *
...
export function realcaseSync(path: string): string | null {
	if (isLinux) {
		...
		// (see also https://github.com/microsoft/zycode/issues/139709)
		return path;
	}
...
export async function realpath(path: string): Promise<string> {
	try {
		...
		// https://github.com/microsoft/zycode/issues/118562
