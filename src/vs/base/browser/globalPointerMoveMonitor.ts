		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/microsoft/zycode/issues/161731
					//
			...
			// See https://github.com/microsoft/zycode/issues/144584
			// See https://github.com/microsoft/zycode/issues/146947
