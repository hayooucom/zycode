...
export class ListView<T> implements IListView<T> {
	...
	constructor(
		...
		// https://github.com/microsoft/zycode/issues/44181
	...
	private onDragOver(event: IListDragEvent<T>): boolean {
		...
		if (StaticDND.CurrentDragAndDropData && StaticDND.CurrentDragAndDropData.getData() === 'zycode-ui') {
			return false;
		}
		...
		while (true) {
			...
			if (!didChange) {
				...
				if (typeof anchorElementIndex === 'number') {
					...
					// See https://github.com/microsoft/zycode/issues/104144
					// See https://github.com/microsoft/zycode/pull/104284
					// See https://github.com/microsoft/zycode/issues/107704
