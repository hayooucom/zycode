...
export abstract class Pane extends Disposable implements IView {
	...
	render(): void {
		...
		// Use role button so the aria-expanded state gets read https://github.com/microsoft/zycode/issues/95996
...
class PaneDraggable extends Disposable {
	...
	private dragOverCounter = 0; // see https://github.com/microsoft/zycode/issues/14470
