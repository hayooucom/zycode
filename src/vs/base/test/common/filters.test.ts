...
suite('Filters', () => {
	...
	test('PrefixFilter - ignore case', function () {
		...
		filterNotOk(matchesPrefix, 'T', '4'); // see https://github.com/microsoft/zycode/issues/22401
	});
	...
	test('Freeze when fjfj -> jfjf, https://github.com/microsoft/zycode/issues/91807', function () {
		assertMatches(
			'jfjfj',
