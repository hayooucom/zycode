...
export function removeDangerousEnvVariables(env: IProcessEnvironment | undefined): void {
	...
	// See https://github.com/microsoft/zycode/issues/130072
	delete env['DEBUG'];

	if (isMacintosh) {
		// Unset `DYLD_LIBRARY_PATH`, as it leads to process crashes
		// See https://github.com/microsoft/zycode/issues/104525
		// See https://github.com/microsoft/zycode/issues/105848
		delete env['DYLD_LIBRARY_PATH'];
	}

	if (isLinux) {
		// Unset `LD_PRELOAD`, as it might lead to process crashes
		// See https://github.com/microsoft/zycode/issues/134177
