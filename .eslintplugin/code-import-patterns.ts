...
export = new class implements eslint.Rule.RuleModule {
	...
	readonly meta: eslint.Rule.RuleMetaData = {
		messages: {
			badImport: 'Imports violates \'{{restrictions}}\' restrictions. See https://github.com/microsoft/zycode/wiki/Source-Code-Organization',
			badFilename: 'Missing definition in `code-import-patterns` for this file. Define rules at https://github.com/microsoft/zycode/blob/main/.eslintrc.json'
		},
		docs: {
			url: 'https://github.com/microsoft/zycode/wiki/Source-Code-Organization'
		}
	};
