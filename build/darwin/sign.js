...
async function main(buildDir) {
    ...
    if (arch !== 'universal') {
        await (0, cross_spawn_promise_1.spawn)('plutil', [
            ...
            '-string',
            'An application in ZY Studio Code wants to use AppleScript.',
            `${infoPlistPath}`
        ]);
        await (0, cross_spawn_promise_1.spawn)('plutil', [
            '-replace',
            ...
            '-string',
            'An application in ZY Studio Code wants to use the Microphone.',
            `${infoPlistPath}`
        ]);
        await (0, cross_spawn_promise_1.spawn)('plutil', [
            '-replace',
            ...
            '-string',
            'An application in ZY Studio Code wants to use the Camera.',
            `${infoPlistPath}`
        ]);
    }
