...
import 'mocha';
import { CancellationTokenSource, CompletionTriggerKind, Selection } from 'zycode';
...
suite('Tests for completion in CSS embedded in HTML', () => {
	...
	// https://github.com/microsoft/zycode/issues/79766
	...
	// https://github.com/microsoft/zycode/issues/117020
	...
	// https://github.com/microsoft/zycode/issues/138461
