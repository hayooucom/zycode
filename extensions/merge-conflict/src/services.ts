...
export default class ServiceWrapper implements zycode.Disposable {

	private services: zycode.Disposable[] = [];
	...
	createExtensionConfiguration(): interfaces.IExtensionConfiguration {
		const workspaceConfiguration = zycode.workspace.getConfiguration(ConfigurationSectionName);
