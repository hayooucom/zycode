...
fn detect_installed_program(log: &log::Logger) -> io::Result<Vec<PathBuf>> {
	...
	//        Location: /Users/connor/Downloads/ZY Studio Code - Exploration 2.app
	//
...
// Based on https://github.dev/microsoft/zycode-js-debug/blob/7594d05518df6700df51771895fcad0ddc7f92f9/src/common/pathUtils.ts#L15
#[cfg(target_os = "linux")]
fn detect_installed_program(log: &log::Logger) -> io::Result<Vec<PathBuf>> {
